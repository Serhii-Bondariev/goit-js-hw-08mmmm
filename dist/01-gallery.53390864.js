...
function murkup(gallery1) {
    return gallery1.map((item)=>{
        console.log(item);
...
gallery.insertAdjacentHTML("beforeend", murkup((0, _galleryItemsJs.galleryItems)));
console.log(murkup((0, _galleryItemsJs.galleryItems)));
